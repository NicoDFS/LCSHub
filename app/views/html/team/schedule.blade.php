...
@foreach($block->getMatches() as $tempCntr => $match)
    ...
    @if(in_array($block->tournamentId, Config::get('standings.approvedTournaments')))
        ...
        <img src="{{ ($match->blueLogoURL !== null ? 'http://na.lolesports.com' . $match->blueLogoURL : 'http://s3-us-west-1.amazonaws.com/riot-api/img/riot-fist-inverted.png') }}" width='55' height='55' style="border-radius: 5%; background: #1A1A1A; padding:5px; margin-bottom:-5px; margin-top:8px; {{ $match->winnerImg($match->blueId) }}">
        ...
        <img src="{{ ($match->redLogoURL !== null ? 'http://na.lolesports.com' . $match->redLogoURL : 'http://s3-us-west-1.amazonaws.com/riot-api/img/riot-fist-inverted.png') }}" width='55' height='55' style="border-radius: 5%; background: #1A1A1A; padding:5px; margin-bottom:-5px; margin-top:10px; {{ $match->winnerImg($match->redId) }}">
    ...
    @else
        ...
        <img src="{{ ($match->blueLogoURL !== null ? 'http://na.lolesports.com' . $match->blueLogoURL : 'http://s3-us-west-1.amazonaws.com/riot-api/img/riot-fist-inverted.png') }}" width='55' height='55' style="border-radius: 5%; background: #1A1A1A; padding:5px; margin-bottom:-5px; margin-top:9px; {{ $match->winnerImg($match->blueId) }}">
        ...
        <img src="{{ ($match->redLogoURL !== null ? 'http://na.lolesports.com' . $match->redLogoURL : 'http://s3-us-west-1.amazonaws.com/riot-api/img/riot-fist-inverted.png') }}" width='55' height='55' style="border-radius: 5%; background: #1A1A1A; padding:5px; margin-bottom:-5px; margin-top:9px;  {{ $match->winnerImg($match->redId) }}">
