                ...
                <table  class="hover">
                    ...
                    <tbody class="no-border-y">
                        ...
                        <tr>
                            ...
                            <td> <img class="img-rounded" style="padding:2px; border:1px solid black; width:32; height:32px; background: #1A1A1A;" src="{{ ($teamKey == $game->blueId ? preg_replace("/^http:/i", "http:", $game->blueLogoURL) : preg_replace("/^http:/i", "http:", $game->redLogoURL) ) }}"> &nbsp;{{ ($teamKey == $game->blueId ? $game->blueName : $game->redName) }}</td>
