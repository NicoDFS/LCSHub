    ...
    public function getVideoPlayer()
    {
        if(Cookie::has(Config::get('cookie.player')))
        {
            ...
            elseif(Cookie::get(Config::get('cookie.player')) == 'youtube' && $this->getLeague()->youtube !== null)
            {
                ...
                return '<iframe width="1280" height="720" src="http://www.youtube.com/embed/' . $this->leagueYoutubeId() . '?autoplay=1&t=100000000&vq=highres&autohide=1&rel=0&iv_load_policy=3&showinfo=0&theme=light&controls=2&color=white" frameborder="0" allowfullscreen></iframe>';
            }
